% Matlab script to test the additivity property for System 2.
...
sgtitle('System 2 - Additivity Test') 

% It was determined that the additivity property does hold for System 2.